...
| `网文拆文模板包/` | 拆文提示词 + Excel 工作表（学节奏 / 提卖点） |
...
| 文件 | 作用 |
|------|------|
| `00-使用说明.md` | 流程、Excel 七页分工、使用边界 |
| `拆文AI提示词模板.md` | 4 套可复制提示词（逐章 / 结构 / 人物 / 卖点） |
| `网文拆文工作表.xlsx` | 承接 AI 输出；「节奏统计」为公式自动算 |
