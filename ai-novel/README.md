...
| `webnovel-breakdown-kit/` | 网文拆文：提示词 + Excel 工作表（学节奏 / 提卖点） |
...
目录：`webnovel-breakdown-kit/`（中文名：网文拆文模板包）

用 **AI 提示词 + Excel 工作表** 把小说拆成结构化数据，再看节奏统计（爽点密度、情绪/钩子分布、伏笔回收率等）。适合学开篇节奏、对标拆书、提炼简介与卖点。

| 文件 | 作用 |
|------|------|
| `README.md` | 流程、Excel 七页分工、使用边界 |
| `ai-prompts.md` | 4 套可复制提示词（逐章 / 结构 / 人物 / 卖点） |
| `breakdown-workbook.xlsx` | 承接 AI 输出；「节奏统计」为公式自动算 |

最短路径：先读使用说明 → 基础信息写清拆解目的 → 每次 5～10 章用模板 1 → 粘贴进「逐章拆解」→ 看节奏统计。不必拆完整本，黄金三章 + 若干高潮章往往就够。

来源：公众号「勇鹏在用 AI」实验③配套材料（作者署名：月月鸟）。本包不含任何小说正文版权内容。
...
| `webnovel-breakdown-kit/` | 网文拆文：AI 提示词 + Excel 工作表 |
| `README.md` | 人读的最短操作路径 |
